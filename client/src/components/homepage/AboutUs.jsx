    ...
    return (
            <Row className="row-about">
                <Col xs={12} sm={6} className="about-quote">
                  <h3>ABOUT US</h3>  
                  <p><span className="span1">Volunteer xChange Box</span> is a social platform made by students in <span className="span2">HFY Belgium</span> that is aimed to connect both volunteers and help seekers within a community so that we can focus on channeling our inner good and assist each other to build a stonger foundation of a better world.</p>
                </Col>
